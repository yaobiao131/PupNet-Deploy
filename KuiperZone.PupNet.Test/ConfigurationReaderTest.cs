...
public class ConfigurationReaderTest
{
    ...
    {
        Assert.Equal("com.example.helloworld", Create().AppId);
    ...
    {
        Assert.Equal("example.com", Create().PublisherLinkName);
    ...
    {
        Assert.Equal("https://example.com", Create().PublisherLinkUrl);
    ...
    [Fact]
    public void AppImageRuntimePath_Optional_DecodeOk()
    {
        Assert.Equal("Runtimes/runtime-x86_64", Create().AppImageRuntimePath);
        Assert.Null(Create(nameof(ConfigurationReader.AppImageRuntimePath)).AppImageRuntimePath);
    }
    ...
    public void UninstallCommand_String_IsValid()
    {
        ...
        Assert.Null(Create(nameof(ConfigurationReader.SetupUninstallScript)).SetupUninstallScript);
    }
