...
public static class MacroIdExtension
{
    ...
    public static string ToName(this MacroId id)
    {
        ...
        switch (id)
        {
            ...
            case MacroId.PublisherId: return "PUBLISHER_ID";
            ...
            case MacroId.PackageArch: return "PACKAGE_ARCH";
    ...
    public static string ToHint(this MacroId id)
    {
        switch (id)
        {
            ...
            case MacroId.PublisherId: return GetConfHelp(nameof(ConfigurationReader.PublisherId));
            ...
            case MacroId.PackageArch: return "Architecture used by package builder. Differs between AppImage and RPM, for example. For AppImage: ";

            case MacroId.BuildArch: return "Build architecture. Always one of: x64, arm64, arm or x86";
