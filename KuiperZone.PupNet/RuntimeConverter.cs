...
public class RuntimeConverter
{
    ...
    /// </summary>
    public Architecture BuildArch { get; } = RuntimeInformation.OSArchitecture;

    /// <summary>
    /// Gets whether runtime-id could NOT be mapped to <see cref="BuildArch"/> with certainty.
    /// </summary>
