...
public sealed class SetupBuilder : PackageBuilder
{
    ...
    /// </summary>
    public static string TerminalIcon { get; } = Path.Combine(SelfAssemblyDirectory, "terminal.ico");
    ...
    {
        get { return GetOutputName(Configuration.SetupVersionOutput, Configuration.SetupSuffixOutput, PackageArch, ".exe"); }
    }
